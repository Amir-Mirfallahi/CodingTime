...
export default function Edit({auth, categories, oldPost}) {
    const {data, setData, post, processing, errors} = useForm(
        {
            'title': oldPost.title,
            'image_path': oldPost.image_path,
            'content': oldPost.content,
            'time_to_read': oldPost.time_to_read,
    ...
    const handlePostUpdate = (e) => {
        e.preventDefault();
        post(route("posts.update", oldPost.id));
    }
        ...
        >
            ...
            <div className="py-12">
                <div
                    ...
                    <form className="px-5 pb-4 pt-8" onSubmit={handlePostUpdate}>
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="grid grid-cols-2 gap-6 items-center">
                                    <TextInput
                                        ...
                                        disabled={processing}/>
                                    <img src={oldPost.image_path} alt={oldPost.title} className="w-fit rounded-lg"/>
                                </div>
                            ...
                            <div className="col-span-full">
                                ...
                                <SelectInput defaultValue={data.category_id} className='w-full'>
